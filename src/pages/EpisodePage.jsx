                            ...
                            <td>
                              {voter && (
                                <Link to={`/season/${sid}/cast/${slugify(voter.name)}`}
                                  ...
                                  <Avatar name={voter.name} color={getTribeColor(season, voter.tid)} size={30} photoUrl={voter.photoUrl} imgStyle={voter.photoStyle} pid={voter.pid} noBorder />
                                  {voter.name}
                                </Link>
                              )}
                            </td>
                            <td>
                              {target && (
                                <Link to={`/season/${sid}/cast/${slugify(target.name)}`}
                                  ...
                                  <Avatar name={target.name} color={getTribeColor(season, target.tid)} size={30} photoUrl={target.photoUrl} imgStyle={target.photoStyle} pid={target.pid} noBorder />
                                  {target.name}
                                </Link>
                              )}
                              {v.idolNullified && (
