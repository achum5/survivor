...
export const SEASONS = [
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    twists: [
      ...
      "Hidden Immunity Idols — Players could find idol clues and idols hidden at camp. Six idols were found or given across the season: Sean (Episode 1, played Episode 5), Caroline (Episode 2, never played), Meredith (Episode 2, played Episode 7), Abdul (Episode 6, given by the game, played Episode 10), Meredith's second idol (Episode 8, played Episode 8 — Alyssa originally found the clue but was voted out before retrieving it; the clue was recycled and Meredith found it, sneaking out at 2:30am to grab it from the mailbox), and Savannah (Episode 9, gave it to Abdul at the Episode 11 tribal council).",
    ...
    advantages: [
      ...
      { type: "Hidden Immunity Idol", holder: "s2_meredith", foundEpisode: 8, playedEpisode: 8, status: "played", notes: "Alyssa originally found the clue to this idol before Episode 7, but was voted out before she could retrieve it. The clue was put back into the game and Meredith found it. The idol was placed in the mailbox between 2am and 5am. Meredith snuck out at 2:30am to retrieve it. Played on herself at Episode 8 tribal council, nullifying Kelsey's vote. Ben W. was eliminated." },
    ...
    cast: [
      ...
      { pid: "s2_caroline",  name: "Caroline",  fullName: "Caroline Kremer",   personId: "caroline_kremer", photoUrl: "https://i.imgur.com/Pq42UDY.png", photoStyle: { objectPosition: "50% -183%", transform: "scale(1.50)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_blue",   placement: 10, juryMember: true, votesAgainst: 4, switchedTid: "s2_beige", merged: true,
        bio: [
          "Caroline returned for Season 2 on the Navy Blue tribe, where she had been a key player in Season 1's endgame. She was part of Blue's four-person majority that voted out Phil unanimously in Episode 2. Despite being on the right side of the numbers, Caroline felt conflicted about the vote.",
          ...
          "She also found a hidden immunity idol at camp during Episode 2 — an advantage she would hold for five episodes but tragically never play.",
          "After the swap, Caroline landed on Beige. She survived the Episode 5 chaos when Sean played his idol and Jacob was eliminated on the revote, but the tribal was nerve-wracking for everyone on Beige.",
          { type: "quote", pid: "s2_caroline", quote: "I'm very stressed. I think it's going to be Jacob or Sean. We think Sean has an idol. So, we're going to try and flush it. And then if Sean flushes it, then maybe Jacob will go home.", episode: 5, context: "before tribal council" },
          "At the Episode 6 merge, Caroline won individual immunity in the Domino Stacking challenge, keeping her safe during the vote that sent Olivia home 6-4. Caroline voted for Sean that round, part of the losing minority. Going into the vote, Caroline sensed that alliances were beginning to crystallize.",
          { type: "quote", pid: "s2_caroline", quote: "[I'm feeling] great this round. However, I don't know how this vote is going to go. There have been multiple names brought up. I think we're definitely testing some alliances. People are starting to piece together who's working with who. Should be interesting.", episode: 6, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_caroline", quote: "As much as I did not want you to win this game, I do think you deserve it. I do think you controlled the game. And my question at the jury was I feel like not very well understood, but it was designed to show people that I do think you are deserving of winning. You're welcome.", episode: 13, context: "jury vote" },
        ] },
      { pid: "s2_benw",      name: "Ben W.",    fullName: "Ben Williams",      personId: "ben_williams", photoUrl: "https://i.imgur.com/177kE7y.png", photoStyle: { objectPosition: "50% -10%", transformOrigin: "50% 20%", transform: "scale(1.3)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 5%" }, tid: "s2_blue",   placement: 8, juryMember: true, votesAgainst: 7, switchedTid: "s2_purple", merged: true,
        bio: [
          "Ben W. played one of the most complex double-agent games of Season 2, but ultimately lost the trust of everyone around him. He started on the Navy Blue tribe alongside his brother Sam W. (who was on Red). On Blue, Ben was part of the four-person majority with Caroline, Jacob, and Ben C. that unanimously voted out Phil in Episode 2. Ben was strategic from the start, intentionally positioning himself in the majority group.",
          { type: "quote", pid: "s2_benw", quote: "It sucks we have to go but I went to the bathroom right when we split off so that I could intentionally join the majority group. So I ended up in the foursome and now it's kind of a 4-2 split. The two are Olivia and Phil. So we're talking about voting one of them out. We considered a 2-2 split just in case Phil has an advantage, but that would leave us vulnerable to one person flipping and making it a 3-2-1.", episode: 2, context: "before tribal council" },
          "After the tribe swap, Ben ended up on Purple — the same tribe as his brother Sam W. When the women's alliance plus Abdul targeted Sam in Episode 3, Ben voted with his brother for Abdul, but they were outnumbered 5-2. Sam was blindsided. Ben described the pre-tribal chaos as unlike anything he'd seen.",
          { type: "quote", pid: "s2_benw", quote: "[I'm feeling] not great. This is chaos. It's complete chaos. It's the most structured, ridiculous chaos I've ever seen. Abdul wants to spin a bottle to figure out who is going to talk to who and I'm trying to organize some stuff and he's very much strongarming everything so that there's only two groups of people. He's trying to line his ducks up. Hate it. We're talking about maybe him, maybe Madison.", episode: 3, context: "before tribal council" },
          "In Episode 4, Ben pivoted hard — he voted for Madison alongside Abdul and Kelsey, despite earlier being on the outs.",
          { type: "quote", pid: "s2_benw", quote: "I got blindsided the last vote. There were three layers of plans I was in on and there was a fourth layer on top of it. These guys are insane. Right now talking with Abdul about maybe [voting] Madison. Madison was unwilling to drop a name, so I don't trust her. I don't feel safe at all. I don't feel good.", episode: 4, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_benw", quote: "I'm the rat right now a little bit. The guys all want to get Olivia. They said walking down, don't tell anybody, we're going to try to flip Savannah. Savannah seemed down. It's all good, but I don't trust them long term. And the connections I have with Kelsey and Alyssa and Caroline. So, I told Kelsey and Alyssa what the plan was, and I said I wanted to work with them. They seem like they're okay with getting rid of Olivia for this vote so that we kind of settle the waters and then I might end up going with them.", episode: 6, context: "before tribal council" },
          "Ben ultimately voted for Sean, putting himself in the minority 6-4 vote. By Episode 7, he won immunity in the Hold Your Breath challenge in his group, keeping him safe. Ben recognized the power of his position as a swing vote.",
          { type: "quote", pid: "s2_benw", quote: "The Denver lungs bought me another day. I have a lot of power right now. I really want to keep Ben C. with me and possibly use him down the road and then it's kind of between Sean and Meredith in my mind. I'm leaning Meredith, but it's kind of in the air. I think people will target Sean later and that can be good for me.", episode: 7, context: "before tribal council" },
          "Meredith's idol play sent Alyssa home 1-0 in the other group. Episode 8 was where it all fell apart. Ben knew his name was spreading, and the loss of his closest allies left him exposed.",
          { type: "quote", pid: "s2_benw", quote: "We feel very endangered right now. I know my name is spreading like wildfire. My biggest alliances were Alyssa and Caroline and they both went home last time. I think it sounds like it's between Meredith and Sean, but I know my name's out there too. I think I want to go for Sean this time.", episode: 8, context: "before tribal council" },
          "Abdul won immunity. The majority alliance planned to flush Meredith's suspected second idol while actually targeting Ben. Meredith had indeed found another idol and played it on herself. Ben used his Shot in the Dark — it missed. He was eliminated 5-1.",
          { type: "quote", pid: "s2_benw", quote: "I kind of flipped on the guys. I didn't want to but they went after Kelsey and that was the problem. I was on board the Olivia boat. They flip on Kelsey and I was aligned with Kelsey. So I told her to play her advantage and then I ended up voting Sean because I thought they might be voting for me. None of the guys trusted me. I asked Ben C. very directly, 'Has my name come up?' And he said no. And I knew they had thrown my name out. At one point there's three people in one room, three people in the other. I try to join both and they both push me away. I've torched everything. I needed Alyssa or Caroline in the game. Them going home really shot me.", episode: 8, context: "final words" },
          "At Final Tribal Council, Ben voted for Abdul, recognizing that Abdul was in control of nearly every vote.",
          { type: "quote", pid: "s2_benw", quote: "I think this was pretty clearly the best game played of the three remaining. It seems like Abdul is in control of all the votes. It's a great game. And Benny should have taken my lifeline. I tried to save you. I knew this is what would happen if you went to the end with him. If you had taken it, we could be sitting there right now instead.", episode: 13, context: "jury vote" },
        ] },
      { pid: "s2_benc",      name: "Ben C.",    fullName: "Ben Currey",        instagram: "https://www.instagram.com/ben_currey/", photoUrl: "https://i.imgur.com/zZ2Uskz.png", photoStyle: { objectPosition: "50% -30%", transformOrigin: "50% 30%", transform: "scale(1.4)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 15%" }, tid: "s2_blue",   placement: 2, juryMember: false, votesAgainst: 0, switchedTid: "s2_beige", merged: true,
        bio: [
          ...
          "After the swap to Beige, Ben survived the Episode 5 chaos. Before that tribal, he identified Sean and Savannah as a dangerous pair.",
          { type: "quote", pid: "s2_benc", quote: "We were all talking. It's a lot going on at once. I think we all agreed that Sean kind of poses a threat, especially him and Savannah later on. They're like a dynamic duo that we kind of want to separate. I heard Jacob's name being thrown around too because of his brother. [Who would you rather go?] I think I'm going to go with Sean.", episode: 5, context: "before tribal council" },
          "He voted for Sean (nullified by the idol) and then voted Jacob on the revote. At the merge, Ben voted with the guys' coalition to take out Olivia 6-4. His read on the game was consistently accurate.",
          ...
          "In the Episode 7 split tribal, Ben was in the group with Ben W., Meredith, Sean, and Alyssa. His strategic read was sharp — he chose to target Meredith over Sean, reasoning that Sean's larger target would shield him later.",
          { type: "quote", pid: "s2_benc", quote: "[I'm feeling] good. It's kind of a Sean vs. Meredith situation. I'm leaning Meredith because Sean definitely has a target on his back, so I'd be okay leaving him in the field. And Meredith's a good player.", episode: 7, context: "before tribal council" },
          "He voted for Meredith, but her idol nullified it and Alyssa went home instead. In Episode 8, he helped orchestrate the plan to flush Meredith's suspected second idol while targeting Ben W., voting with the majority in a 5-1 result.",
          ...
          "With Sean immune in Episode 9, Ben helped the coalition pivot to Ashton.",
          { type: "quote", pid: "s2_benc", quote: "[I think] we're going after Sean this round, but of course he's immune. So we think his biggest ally is Ashton and we don't know who would turn his back on Sean. So that's [who] I think [is] my next [target].", episode: 9, context: "before tribal council" },
          "In Episode 10, Ben's loyalty to Savannah and Abdul guided his vote — he saw eliminating Sean as his clearest path to the final four.",
          { type: "quote", pid: "s2_benc", quote: "I'm thinking best chance for me to make it to the top four where we have the challenges to get top three right now would be to go out Sean because I have a strong bond with Savannah and Abdul. So for this round specifically, I think that's the play. I have a terrible headache and I'm really hungry.", episode: 10, context: "before tribal council" },
          "At the final five, Ben tried to rally votes against Meredith as the biggest threat but sensed Kelsey and Savannah were wavering.",
          { type: "quote", pid: "s2_benc", quote: "Since it's the very last vote, I'm kind of thinking alliances don't matter anymore as much. And I think we should take out who is the biggest threat to us if we make top three. So I'm trying to get the vote for Meredith out except they're giving me mixed signals. Kelsey and Savannah are not giving me straight answers so I feel like they're not on board but we'll see.", episode: 11, context: "before tribal council" },
          "Through it all, Ben was a reliable number who built genuine trust with the people around him. His bond with Savannah and Abdul kept him safe even as the field narrowed.",
          ...
          { type: "quote", pid: "s2_benc", quote: "I'm glad I made the top three because I got my $30 back at least. I probably think [Abdul and Savannah] played really good games and I was maybe not as aggressive as them. So I think that might go against me in the vote. But either way, I made the top three. I think I played a fairly loyal game mostly. I wasn't the one ever really throwing any blindsides, but I could get people to do that. I'm not great at lying, so I tried to play on the fact that I can't do it. So I just was pretty truthful the whole time.", episode: 13, context: "Final Tribal Council" },
      ...
      { pid: "s2_jacob",     name: "Jacob",     fullName: "Jacob Williams",    personId: "jacob_williams", photoUrl: "https://i.imgur.com/IKBqmSa.png", photoStyle: { objectPosition: "50% -162%", transformOrigin: "49% 50%", transform: "scale(1.70)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_blue",   placement: 12, juryMember: true, votesAgainst: 5, switchedTid: "s2_beige", merged: false,
        bio: [
          "Jacob was a returning player from Season 1 who was drafted onto the Navy Blue tribe. On Blue, he was part of the four-person majority with Ben W., Caroline, and Ben C. that unanimously voted out Phil in Episode 2. At that tribal, Jacob felt secure and was already comfortable running deception plays on his target.",
          { type: "quote", pid: "s2_jacob", quote: "I feel pretty safe this tribal. I think we're deciding between Phil and whether he has an advantage after that little excursion. We totally told him a lie — we pretended like we're switching to someone. And I don't feel good about it.", episode: 2, context: "before tribal council" },
          "Jacob won the puzzle portion of the Episode 4 Blind Leading the Blind challenge, helping Beige (his post-swap tribe) secure immunity. After the tribe swap, Jacob landed on Beige alongside Sean, Savannah, Ashton, Ben C., Caroline, and Olivia. The tribe won the Episode 3 and Episode 4 immunity challenges, keeping them safe. But when Beige finally lost the Episode 5 Careful Jenga challenge, Jacob found himself in the crossfire of one of the season's most chaotic tribals.",
          "The target was supposed to be Sean, who the tribe suspected had a hidden immunity idol. Jacob knew about it — he and Olivia had figured it out days earlier — but there was no way to avoid the fallout. Caroline sensed the vote would come down to Jacob or Sean.",
          { type: "quote", pid: "s2_caroline", quote: "I'm very stressed. I think it's going to be Jacob or Sean. We think Sean has an idol. So, we're going to try and flush it. And then if Sean flushes it, then maybe Jacob will go home.", episode: 5, context: "before tribal council" },
      ...
      { pid: "s2_olivia",    name: "Olivia",    fullName: "Olivia Saylor",     personId: "olivia_saylor", photoUrl: "https://i.imgur.com/v15gL2S.png", portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_blue",   placement: 11, juryMember: true, votesAgainst: 7, switchedTid: "s2_beige", merged: true,
        bio: [
          "Olivia returned to Season 2 on the Navy Blue tribe, where she was part of the majority but also found herself on the outs. In Episode 2, when the tribe targeted Phil, Olivia joined the 5-0 vote despite being closer to Phil than anyone else — a pragmatic decision to stay in the majority's good graces. Going into that tribal, Olivia was already thinking about the bigger picture.",
          { type: "quote", pid: "s2_olivia", quote: "[I think] it's going to really show who's aligned with who. Obviously, the two brothers are aligned together. So it's like do you work with them or do you work against them? Eventually they have to go out but do I do it now or do I do it later?", episode: 2, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_olivia", quote: "Terrible. Every room I go to, different name. Different name. Different name. So now I think I'm in trouble. Anybody but me, I'll be fine. [Who are you hearing?] Jacob, Sean, Ashton is what I'm hearing, but I think people are just throwing names out so I feel comfortable. [Who are you voting?] Sean, I think.", episode: 5, context: "before tribal council" },
          "At the Episode 6 merge, Olivia knew she was in danger but believed she had enough votes to survive. She was caught between the girls' alliance targeting Sean and the guys' alliance targeting Alyssa.",
          { type: "quote", pid: "s2_olivia", quote: "[I'm feeling] okay. I think I'm okay this round, but I'm in trouble. I know people are saying my name, but I think I have enough votes to get me through. [Who are you going for?] It depends on if I want to stick with the girls or not. The girls want to vote either Sean or Ben W., but then all the guys want to vote Alyssa. So, it's like I have to go with one of the majorities. It's just who do I find is a bigger threat.", episode: 6, context: "before tribal council" },
          "But the game split along gender lines. The guys formed a coalition and pulled Savannah and Alyssa over to their side, targeting Olivia. Kelsey played her Safety Without Power and left tribal before the vote. Ben W. had been playing both sides — he told the girls the guys' plan but ultimately voted with them.",
      ...
      { pid: "s2_phil",      name: "Phil",      fullName: "Phil Johnson",      instagram: "https://www.instagram.com/phill_johnson/", photoUrl: "https://i.imgur.com/75A82Z1.png", photoStyle: { objectPosition: "50% -20%", transformOrigin: "50% 25%", transform: "scale(1.3)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 10%" }, tid: "s2_blue",   placement: 16, juryMember: true, votesAgainst: 5, switchedTid: null, merged: false,
        bio: [
          ...
          "His tribemates debated splitting the vote in case Phil had an advantage from the journey, but ultimately decided it wasn't worth the risk of someone flipping. Jacob, who was in the majority, felt safe — and confirmed that Phil was the target they were testing.",
          { type: "quote", pid: "s2_jacob", quote: "I feel pretty safe this tribal. I think we're deciding between Phil and whether he has an advantage after that little excursion. We totally told him a lie — we pretended like we're switching to someone. And I don't feel good about it.", episode: 2, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_caroline", quote: "[I think] it's going to be Phil, which I hate to say because I really love Phil. But yeah, I think he's going to go and I'm sad.", episode: 2, context: "before tribal council" },
          "Phil took his elimination in stride, noting the telltale sign that gave it away.",
          { type: "quote", pid: "s2_phil", quote: "I knew they were going to vote me out. Eye contact is important. I had zero. And now they're going to be starving while I drink my alcohol. So, congrats.", episode: 2, context: "final words" },
      ...
      { pid: "s2_alyssa",    name: "Alyssa",    fullName: "Alyssa French",     instagram: "https://www.instagram.com/alyssafrenchh/", photoUrl: "https://i.imgur.com/3u6Wor2.png", photoStyle: { objectPosition: "50% -10%", transformOrigin: "50% 22%", transform: "scale(1.3)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 5%" }, tid: "s2_red",    placement: 9, juryMember: true, votesAgainst: 1, switchedTid: "s2_purple", merged: true,
        bio: [
          "Alyssa started on the Red tribe, where she was one of three new players alongside Kylea and Sam W. The returning trio of Abdul, Madison, and Meredith dominated Red's strategy, and Alyssa fell in line — voting with the majority to eliminate Kylea in Episode 2. She recognized the power dynamics immediately.",
          { type: "quote", pid: "s2_alyssa", quote: "It's really intense. We have three really strong returning players and then outsiders. There are like three or four big threats. I might have to give in to the vote that everyone else is making. [Who is it?] I think it's Kylea.", episode: 2, context: "before tribal council" },
          "After the tribe swap, Alyssa went to Purple. She continued voting with the majority, joining the women's alliance that blindsided Sam W. in Episode 3 and then voting for Madison in Episode 4 when Abdul flipped the target. Going into the Episode 4 tribal, Alyssa was unsure who the real target was.",
          ...
          { type: "quote", pid: "s2_alyssa", quote: "[How are you feeling about this tribal?] I'm scared. I don't know. I feel like we're going to vote for Ben, but I'm scared that that's fake.", episode: 4, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_alyssa", quote: "[I'm feeling] crazy. There's crazy stuff going on in there right now. It's all snakes. Everybody's a snake. I don't know who to trust. I don't trust anyone actually. And everybody's got that look in their eyes and I'm really scared. [Who are you hoping goes home?] Olivia. [Who's going to be with you in that vote?] Sean, Savannah, Kelsey, Caroline.", episode: 6, context: "before tribal council" },
          "Episode 7 sealed Alyssa's fate. The merged tribe was split into two groups for separate tribal councils. Alyssa was grouped with Ben W., Meredith, Sean, and Ben C. The target was Meredith, and Alyssa went along. Alyssa had found a clue to the 2am mailbox idol — she needed to survive this tribal to have a chance to retrieve it. But others suspected she might already have an idol, putting a target on her back.",
          ...
          "Meredith played her hidden immunity idol, nullifying all four votes against her. Meredith's single vote for Alyssa was the only one that counted, and Alyssa was eliminated 1-0 in one of the most dramatic tribals of the season. Alyssa was voted out still holding the idol clue, never getting the chance to retrieve it. The clue was put back into the game, and Meredith would later find it and claim the idol herself.",
      ...
      { pid: "s2_kylea",     name: "Kylea",     fullName: "Kylea Dobson",      instagram: "https://www.instagram.com/kdobson_12/", photoUrl: "https://i.imgur.com/Ys122rX.png", photoStyle: { objectPosition: "50% 20%", transformOrigin: "50% 25%", transform: "scale(1.15)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 10%" }, tid: "s2_red",    placement: 15, juryMember: true, votesAgainst: 4, switchedTid: null, merged: false,
        bio: [
          ...
          "Even Alyssa, a fellow newcomer, saw no choice but to go along with the majority.",
          { type: "quote", pid: "s2_alyssa", quote: "It's really intense. We have three really strong returning players and then outsiders. There are like three or four big threats. I might have to give in to the vote that everyone else is making. [Who is it?] I think it's Kylea.", episode: 2, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_kylea", quote: "I got voted out. I thought we were voting Sam, so I was a little bit bummed, but everybody lied to me.", episode: 2, context: "final words" },
      ...
      { pid: "s2_abdul",     name: "Abdul",     fullName: "Abdul Alwan",       personId: "abdul_alwan", photoUrl: "https://i.imgur.com/O18he6C.png", photoStyle: { objectPosition: "50% -91%", transformOrigin: "66% 50%", transform: "scale(1.65)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_red",    placement: 1, juryMember: false, votesAgainst: 3, switchedTid: "s2_purple", merged: true,
        bio: [
          ...
          { type: "quote", pid: "s2_abdul", quote: "It's pretty dirty in there, but I think Sam or Kylea is going to be the one to go, or myself. [Who are you voting for?] Kylea. I think she's very athletic, but she wants to play every single challenge and it sometimes brings us down.", episode: 2, context: "before tribal council" },
          "After the swap to Purple, Abdul took control. In Episode 3, the Williams brothers (Sam W. and Ben W.) targeted him, but Abdul read the dynamics clearly and organized a 5-2 vote that blindsided Sam W.",
          ...
          "In Episode 4, Abdul pulled off what he called \"the greatest move in Survivor history\" — flipping the vote from Kelsey to Madison after Madison got cold feet and refused to commit to a target.",
          ...
          { type: "quote", pid: "s2_abdul", quote: "I got my nail torn out and man did that hurt. I am playing the biggest game and I am trying to switch everyone to go Madison. I tried to make an alliance with her, but I just cannot trust her. If this works, I pulled off the greatest [move] in Survivor history.", episode: 4, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_abdul", quote: "[I'm] back into familiar territory. Won a challenge every single year. Same thing. Feeling good, feel safe now. I'm kind of just controlling. Everybody's like real puppets in my hands. And I think Caroline [is going home] and that's from what she did to me last year. Revenge is a bitch.", episode: 7, context: "before tribal council" },
          "Abdul won the Episode 8 Who Do You Think They Think? immunity challenge after a three-way tiebreaker. He was in on the plan to flush Meredith's suspected second idol while actually targeting Ben W.",
          { type: "quote", pid: "s2_abdul", quote: "I won. It's pretty easy. I just had to guess myself basically 80% of the time. We found out that Meredith has an idol and we want her to play it. So we're trying to mislead her into thinking we're voting her so we can get Ben out. And then next round, we would target the big alpha tyrant Sean because he's been running the game from behind the scenes. I thought I had a loud voice, but Sean speaks over me and I sit down and listen. We got to get that man out of here.", episode: 8, context: "before tribal council" },
          "Meredith played her idol, but the target was always Ben W., who was eliminated 5-1. In Episode 9, Abdul used his Final 7 Advantage for a bye into the Simon Tournament semifinals, but Sean beat him. The coalition pivoted to Ashton, who was blindsided 5-1-1.",
          { type: "quote", pid: "s2_abdul", quote: "Everyone doesn't want to sit next to me at the final three and there's some scheming going on to get me out, but I think I might have just turned it on Sean. I think Ashton might be going home just because he's going to align with Sean and just kind of follow his tail.", episode: 9, context: "before tribal council" },
          "In Episode 10, Abdul saw through Sean's bluff about having an idol and was ready for a showdown.",
          { type: "quote", pid: "s2_abdul", quote: "Sean's a little bit hurt that everybody switched on him. He tried backtracking as soon as we came out of that vote. I know dang well that he put my name on there and he tried to tell Meredith to play an idol to save herself. So his one vote would go against me. He's now sitting on a couch, not really talking to a whole bunch of people. Claims he has an idol, but I think he's bluffing. One good thing is I have an idol too. So we might see two idols being played tonight.", episode: 10, context: "before tribal council" },
          "Abdul played his idol on himself, nullifying two votes from Meredith and Sean. He didn't need to — the majority of four had already locked in their votes against Sean, who was eliminated 4-0. It was a wasted idol play, but Abdul couldn't know that at the time.",
          ...
          { type: "quote", pid: "s2_abdul", quote: "A lot of scheming going on, but hoping we're swinging the votes towards Meredith. I think she'll be the only one that would scare me. Obviously if we were to make it to top three, me and Savannah, we would have a battle. I pissed off a lot of people in tribal. So I think she has an edge on me, which I'm trying to convince her not to take Meredith and to take me if we made it this far. Fingers crossed.", episode: 11, context: "before tribal council" },
          "In the finale, Abdul solved the Kanoodle puzzle in under three minutes to win immunity. Before the fire-making challenge, Abdul confirmed what everyone suspected — he was always taking Savannah.",
          { type: "quote", pid: "s2_abdul", quote: "I hopefully take one person with me. I'm going to let you in on a little secret. Not a lot of people know. Savannah did me a solid, so I'm doing her a solid. She's coming to top three with me. We'll battle it off. She won a couple challenges. I won a couple challenges. So we'll see whoever the jury likes a little bit more.", episode: 12, context: "before fire-making" },
          "At Final Tribal Council, Abdul made his case as the season's most aggressive player — the one who directed every vote, found two advantages, and survived being targeted repeatedly.",
      ...
      { pid: "s2_madison",   name: "Madison",   fullName: "Madison Chumbler",  personId: "madison_chumbler", photoUrl: "https://i.imgur.com/VBmfwXj.png", photoStyle: { objectPosition: "50% -73%", transform: "scale(1.65)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_red",    placement: 13, juryMember: true, votesAgainst: 4, switchedTid: "s2_purple", merged: false,
        bio: [
          ...
          "After the tribe swap, Madison landed on Purple. The tribe lost the Episode 3 Slingshot challenge, and Abdul began steering the vote toward Sam W. Madison was initially on board — the women formed an alliance and Sam was the target.",
          { type: "quote", pid: "s2_madison", quote: "Sam's being sneaky again. [Is that who you want to go?] Yeah, we just made a girl alliance. It's kind of fun.", episode: 3, context: "before tribal council" },
          "The plan worked, and Sam was blindsided 5-2.",
          { type: "quote", pid: "s2_madison", quote: "Sam's being sneaky again. [Is that who you want to go?] Yeah, we just made a girl alliance. It's kind of fun.", episode: 3, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_abdul", quote: "I got my nail torn out and man did that hurt. I heard chatter about Meredith throwing it out there with the two brothers. I am playing the biggest game and I am trying to switch everyone to go Madison. I tried to make an alliance with her, but I just cannot trust her. If this works, I pulled off the greatest [move] in Survivor history.", episode: 4, context: "before tribal council" },
      ...
      { pid: "s2_meredith",  name: "Meredith",  fullName: "Meredith Hogue",    personId: "meredith_hogue", photoUrl: "https://i.imgur.com/47WJZvC.png", photoStyle: { objectPosition: "50% -63%", transform: "scale(1.55)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%", transformOrigin: "47% 50%", transform: "scale(1.15)" }, tid: "s2_red",    placement: 5, juryMember: true, votesAgainst: 2, switchedTid: "s2_purple", merged: true,
        bio: [
          ...
          { type: "quote", pid: "s2_meredith", quote: "I'm feeling pretty confident. I feel safe right now. I think the group has come to a good consensus of who we want to get rid of. [Who is that?] I think Kylea.", episode: 2, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_meredith", quote: "[I'm feeling] good still. I have some strong alliances and I feel like we're going to try to break up the Williams brothers. [Which one are you going for?] Sam.", episode: 3, context: "before tribal council" },
          "By Episode 4, the tribe was fractured. Meredith wanted Alyssa or Kelsey out, seeing Kelsey as a merge threat, but Abdul had other plans.",
          { type: "quote", pid: "s2_meredith", quote: "[What's about to happen?] I honestly have no idea. We have not come to a consensus at all. Everyone is throwing out everyone's name, so I have no idea. [Who would you most want to go?] I think right now I would want Alyssa or Kelsey. I feel like Kelsey is dangerous when we get to the merge, and Alyssa just doesn't really have anybody.", episode: 4, context: "before tribal council" },
          "At the merge in Episode 6, Meredith found herself in the minority. She sensed that Kelsey, Abdul, and Alyssa had formed a secret alliance after voting out Madison without telling her.",
          { type: "quote", pid: "s2_meredith", quote: "[I'm feeling] good. I'm feeling a little nervous this time. I feel like Kelsey, Abdul, and Alyssa have some sort of alliance after they all voted Madison out without telling me. I feel like they're trying to get people to put me out, so I'm a little nervous.", episode: 6, context: "before tribal council" },
          "The game split along gender lines, and Olivia was eliminated 6-4. Meredith voted for Sean alongside Caroline, Olivia, and Ben W.",
          ...
          "Meredith wasn't done. Alyssa had found a clue to a second idol before being voted out, but the clue was put back into the game after her elimination. Meredith found the recycled clue — the idol was placed in the mailbox between 2:00 and 5:00 AM. She snuck out at 2:30 in the morning to retrieve it — a bold move that Kelsey may have noticed.",
          { type: "quote", pid: "s2_meredith", quote: "I woke up right at 2:30 and made it out [to the mailbox] without anyone seeing me. When I came back, I'm pretty sure Kelsey saw me. [I'm] obviously really nervous after last tribal getting voted by everybody. I think Sean is coming for me. I think him and Abdul have some sort of alliance now. So I think either they're going to vote me or Ben Williams.", episode: 8, context: "before tribal council" },
          ...
          "In Episode 9, Meredith believed the guys had manipulated Kelsey into targeting her, and she suspected another round of votes coming her way.",
          { type: "quote", pid: "s2_meredith", quote: "[I'm feeling] good. I think last [tribal] the guys definitely convinced Kelsey to convince me that they were all going to vote for me, which is why I used my [immunity] idol. And I think they're all going to vote for me this time now that I don't have an idol. So I'm feeling a little scared.", episode: 9, context: "before tribal council" },
          "In reality, Kelsey organized a 5-1-1 blindside of Ashton, and Meredith voted with the majority. In Episode 10, Meredith felt more confident and helped rally votes against Sean.",
          { type: "quote", pid: "s2_meredith", quote: "[I'm feeling] a little more confident going into this round. I think I formed some of my original alliances back and I think we're all in a good like group consensus that we're going with Sean.", episode: 10, context: "before tribal council" },
          "She voted for Abdul (nullified by his idol) as Sean was eliminated 4-0. But at the final five in Episode 11, Meredith's run ended. Savannah gave her idol to Abdul, who played it on himself. All four votes against Abdul were nullified, and Abdul's single vote for Meredith was the only one that counted. Meredith sensed it was coming.",
          { type: "quote", pid: "s2_meredith", quote: "I honestly don't know what to think at this point. Savannah obviously has immunity. I think she was kind of our next play because I think we're wanting to kick Ben C. because he's just kind of there. So I think it'll probably be me voted out this round.", episode: 11, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_meredith", quote: "I'm going with Abdul. I think overall he played a great game. He had a lot of big strategic moves. He was basically leading every vote in every tribal. He was the loudest voice in the room and I think getting Savannah to give him her idol was insane.", episode: 13, context: "jury vote" },
        ] },
      { pid: "s2_samw",      name: "Sam W.",    fullName: "Sam Williams",      instagram: "https://www.instagram.com/sam.williams123/", photoUrl: "https://i.imgur.com/3J8BU5u.png", photoStyle: { objectPosition: "50% 15%", transformOrigin: "50% 25%", transform: "scale(1.15)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 10%" }, tid: "s2_red",    placement: 14, juryMember: true, votesAgainst: 5, switchedTid: "s2_purple", merged: false,
        bio: [
          "Sam W. came into Season 2 on the Red tribe alongside his brother Ben W. (who was on Navy Blue). The Williams brothers — Sam W. and Ben W. — were a known pair, and that connection made Sam a target from early on. Red won immunity in Episode 1 and survived Episode 2 when the group unanimously voted out Kylea instead. Even then, Sam was already wary of the returning players on his tribe.",
          { type: "quote", pid: "s2_samw", quote: "I'm very scared of Madison. I don't want to keep her in the game, but we do not have the manpower right now. She's the one I'm most scared of. I think it's either Madison or Meredith that has the idol right now.", episode: 2, context: "before tribal council" },
      ...
      { pid: "s2_savannah",  name: "Savannah",  fullName: "Savannah Brinley",  personId: "savannah_brinley", photoUrl: "https://i.imgur.com/s9JnOdy.png", photoStyle: { objectPosition: "50% -22%", transformOrigin: "22% 50%", transform: "scale(1.50)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_yellow", placement: 3, juryMember: false, votesAgainst: 0, switchedTid: "s2_beige", merged: true,
        bio: [
          ...
          "She started on the Yellow tribe, where she formed a core alliance with Sean and Kelsey. Going into the first tribal, Savannah was caught between competing plans and unsure which way the vote would break.",
          { type: "quote", pid: "s2_savannah", quote: "[I'm feeling] very nervous, very confused. I have no idea what's going on actually still. We're looking at voting out maybe two people and I don't know which one's actually going to happen. I feel like they're probably talking about it right now and hopefully it's not me. Kelsey is a possibility. Sean is acting like he's not feeling well to get Sam out, which is what Kelsey and them think. But Kelsey's name has been thrown out. Not by me, but I am looking at my options.", episode: 1, context: "before tribal council" },
          "The trio blindsided Sam R. 3-2 in Episode 1, with Savannah casting one of the three votes. After the swap, Savannah landed on Beige, where her tribe won the Episode 3 and 4 immunity challenges.",
          ...
          "At the merge, Savannah was caught between two alliances but ultimately chose to go with her gut.",
          { type: "quote", pid: "s2_savannah", quote: "[I'm] not feeling too bad. But I am still a little bit confused about who I'm going to write down, but not really at the same time because I really want to vote Olivia out for last tribal, but there are like two alliances going on and I am kind of in between both of them. I am going with my gut and writing Olivia down.", episode: 6, context: "before tribal council" },
          "Savannah voted with the guys' coalition to eliminate Olivia 6-4 — a pragmatic move to stay in the majority. In the Episode 7 split tribal, she voted for Caroline alongside Abdul, Kelsey, and Ashton.",
          ...
          "By Episode 8, Savannah was fed up with Sean's gameplay and in on the plan to flush Meredith's idol.",
          { type: "quote", pid: "s2_savannah", quote: "I can't wait till Sean sees [what's coming] because he's freaking crazy and being psychotic. Everybody wants to vote for him but they also don't. I think we know Meredith has an idol because she found it yesterday. We're trying to have her think [she's the target] and hopefully flush it out.", episode: 8, context: "before tribal council" },
          "In Episode 9, Savannah expected Ashton to go but sensed potential chaos.",
          { type: "quote", pid: "s2_savannah", quote: "I feel a little bit better about this one. I think that Meredith will play her Shot in the Dark and Ashton will probably go home if it goes the way we want. But I think something might be going crazy too. So I don't know.", episode: 9, context: "before tribal council" },
          "Savannah's individual challenge prowess emerged in the late game. She won the Episode 10 Ice Breaker immunity challenge, sharing her Oreos reward with Meredith. With her own idol in her pocket, Savannah felt secure heading into the Sean vote — she correctly read his idol claim as a bluff.",
          { type: "quote", pid: "s2_savannah", quote: "Either way is a win, I guess. But I get to go to final five no matter what. Sean I think is bluffing about an idol and I think that's who's going to go home. But I guess if he's not bluffing, I think we'll probably go home.", episode: 10, context: "before tribal council" },
          "She won again in Episode 11 with the Internal Clock challenge, stopping her mental timer at 4:30 — the closest to five minutes without going over.",
          ...
          "In the finale, Abdul won the Kanoodle puzzle immunity. Savannah was confident Abdul would honor their deal — and she was right.",
          { type: "quote", pid: "s2_savannah", quote: "I do think Abdul's going to take me to final three. If I have to do dominoes, I think I might be okay at it. If I have to go against Ben, I think I should be okay. Sorry, Ben.", episode: 12, context: "before fire-making" },
          "Abdul chose Savannah to join him in the final three — repaying the debt from her idol gift. At Final Tribal Council, Savannah highlighted her challenge wins and her game-changing idol play, but struggled to separate her legacy from Abdul's.",
      ...
      { pid: "s2_samr",      name: "Sam R.",    fullName: "Sam Roth",          personId: "sam_roth", photoUrl: "https://i.imgur.com/HfnY3vo.jpeg", photoStyle: { objectPosition: "50% -10%", transform: "scale(1.20)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_yellow", placement: 17, juryMember: true, votesAgainst: 3, switchedTid: null, merged: false,
        bio: [
          ...
          "Sam chose not to play his Safety Without Power, trusting his position in the tribe. The vote came back 3-2 — Sean, Savannah, and Kelsey voted Sam, while Sam and Ashton voted Kelsey. Sam became the first person voted out of Season 2, his advantage still in his pocket. In his exit confessional, Sam was stunned — he thought revealing his advantage would earn trust, not make him a target.",
          { type: "quote", pid: "s2_samr", quote: "Honestly, I don't know. I was told to vote Kelsey. I honestly thought that was the play. I thought telling them I had the idol would have been a play that they would have wanted to team up with me later on down the line. But taking the idol out of the game and taking me out of the game, I'm kind of surprised by it.", episode: 1, context: "final words" },
      ...
      { pid: "s2_kelsey",    name: "Kelsey",    fullName: "Kelsey Brown",      personId: "kelsey_brown", photoUrl: "https://i.imgur.com/vb5oY6d.png", photoStyle: { objectPosition: "50% -11%", transform: "scale(1.05)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_yellow", placement: 4, juryMember: true, votesAgainst: 2, switchedTid: "s2_purple", merged: true,
        bio: [
          ...
          "Before Yellow's first tribal, Kelsey was already playing a double game — pretending to work with Sam while secretly planning his blindside.",
          { type: "quote", pid: "s2_kelsey", quote: "[I'm feeling] not good. I think someone has [the idol]. Someone's lying. I think it's Sam. We're going to try to go for him and say that Sean is hurt, he's just not feeling good, and he's okay to go out. My plan is to try to get out with Sam to find the idol with him, to make him think I'm with him because he did pick me. So I think he was open to it.", episode: 1, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_kelsey", quote: "[I'm feeling] not good. Still I think everybody's scrambling. I have a Safety Without Power. We're still scrambling in there. Sounds like there's two groups kind of forming, but there's some slippage. [Who are you hoping goes?] Sam. I'm scared of him.", episode: 3, context: "before tribal council" },
          "In Episode 4, Kelsey's name was in danger again, and she debated playing her Safety Without Power but decided the risk wasn't worth it.",
          { type: "quote", pid: "s2_kelsey", quote: "Madison puts my name out there. It's going to be close. Just a matter of who I can trust. On the fence of using [my] advantage, but I think if we do that, then the votes will be split and we'll get nowhere. It's going to be risky, but hopefully I can trust two people.", episode: 4, context: "before tribal council" },
          ...
          "Post-merge, Kelsey reflected on her Safety Without Power play from the merge and apologized in advance to Caroline, whose elimination she saw coming.",
          { type: "quote", pid: "s2_kelsey", quote: "I evidently didn't really need to use my [Safety Without Power], but it was too risky. I had heard my name too many times. Now somebody's going to be betrayed, so I'm hoping it's not me. I'm so sorry, Caroline. We only formed together this past time, so I just don't feel like we had a long-standing alliance that I can trust.", episode: 7, context: "before tribal council" },
          "In Episode 7, Kelsey voted Caroline out alongside Abdul, Savannah, and Ashton. By Episode 8, Kelsey was unsure of her own position — aware of Sean's alliance but uncertain whether she was in or out of it.",
          { type: "quote", pid: "s2_kelsey", quote: "There's obviously a tight little alliance, probably Sean being the leader. And then there's kind of a few stragglers trying to team up against Sean. [Am I a straggler?] I don't know. I really don't know.", episode: 8, context: "before tribal council" },
          "She voted for Meredith (nullified by Meredith's idol), and Ben W. went home instead. By Episode 9, Kelsey organized the blindside of Ashton — seeing through Sean's manufactured rumor about Meredith having an idol.",
          { type: "quote", pid: "s2_kelsey", quote: "Our \"leader\" Sean came up with this story that Meredith has an idol in her sleeve, but I truly don't think she has it. As of right now, we have a solid four, potentially five that will vote for Ashton in hopes to take down the Sean and Ashton alliance. I think Sean and Ashton pulled me up [to the reward] just to try to get me on their side. So hopefully we're going with [Ashton] and we're telling Sean and Ashton [we're voting Meredith].", episode: 9, context: "before tribal council" },
          ...
          "At the final five, Kelsey was torn between two paths — gamble that Abdul wouldn't have an idol, or align with him and hope for a seat in the final three.",
          { type: "quote", pid: "s2_kelsey", quote: "It sounds like it's down to either Meredith or Abdul. However, Savannah has individual immunity and an immunity idol. So we're thinking she's gonna give it to Abdul to play, keep those two safe, and whoever Abdul votes essentially would get it. But I don't know. Right now I'm kind of in the middle of going with Meredith and Ben to vote Abdul, hope he doesn't play his or Savannah's, or just try to go along with Savannah and Abdul and hope he'll let me into final three. I really don't know. And they could also be scheming behind my back.", episode: 11, context: "before tribal council" },
          "Kelsey voted for Abdul, but Savannah's idol gift to Abdul nullified all four votes. Meredith went home. In the finale, Abdul won immunity and chose Savannah for the final three. Kelsey faced Ben C. in the dominoes fire-making challenge. She had an early lead but knocked her chain over; Ben C. caught up and won.",
          "Before the fire-making challenge, Kelsey reflected on her final five vote — she had voted Abdul not out of betrayal, but to demonstrate independent thinking to the jury.",
          { type: "quote", pid: "s2_kelsey", quote: "I'm pretty much accepting I'm going to do dominoes. Even though I think Abdul's going to take Ben because he feels very me and Savannah. I did tell him, which is the truth, that the last vote, the people that were starting the Abdul vote were Meredith and Ben, which is true. Me and Savannah were kind of going back and forth the whole time. I just really didn't know what the best move was. The reason I went with Abdul is because I was trying to show the jury some individualism that I'm not just following Abdul and I was trying to make a big move.", episode: 12, context: "before fire-making" },
          { type: "quote", pid: "s2_kelsey", quote: "I lost on the domino challenge. I think I was beating Ben. I had a good strategy, but I knocked them over and he got it. So good job to Ben. Trying to think who's going to make it out of final three. I think Savannah and Ben have a good shot. I'm thinking [Abdul] made some people angry, but I don't know. I think I played hard. I think I had some really good moves. I made it way further than I ever thought I would. I had fun. Thank you.", episode: 12, context: "final words" },
      ...
      { pid: "s2_sean",      name: "Sean",      fullName: "Sean Stephens",     personId: "sean_stephens", photoUrl: "https://i.imgur.com/VjBqAOH.png", photoStyle: { objectPosition: "50% 15%" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 15%" }, tid: "s2_yellow", placement: 6, juryMember: true, votesAgainst: 8, switchedTid: "s2_beige", merged: true,
        bio: [
          "Sean was a returning player from Season 1 who came into Season 2 on the Yellow tribe with a reputation as a strategic threat. He found a hidden immunity idol at camp during Episode 1. On Yellow, Sean, Savannah, and Kelsey formed a tight three that blindsided Sam R. 3-2, with Sean faking an injury to sell the plan.",
          { type: "quote", pid: "s2_sean", quote: "I have my idol in my pocket. Probably won't use it because I feel pretty good about the vote. I told Sam that I'm going home because my neck hurts, I don't feel good. So I think he thinks that I'm just going to throw himself on the chopping block. But not sure if that's the best for my game just yet. So we might switch that up.", episode: 1, context: "before tribal council" },
          ...
          { type: "quote", pid: "s2_sean", quote: "There's a lot going on. Everybody's throwing everybody's name out. I have an idol. May play it. Don't know yet. May play a shot in the dark. A couple people know about the idol but everybody still has everybody's name out. The only person I haven't heard is my name. I'm kind of in line with Savannah and Ashton. I think it'll probably be Olivia or Jacob tonight.", episode: 5, context: "before tribal council" },
          ...
          "At the merge, Sean tried to organize the guys but discovered one of them was working against him.",
          { type: "quote", pid: "s2_sean", quote: "We're boys and girls right now. The boys have been able to pull Alyssa and Savannah over with us. But now we find out that one of the boys is a snake in the grass. [Who's that?] Ben Williams, the brother. Little bit of a snake. We might flip to him. We might vote Olivia. We might do something else. Haven't decided yet, but we'll figure it out before tribal. [You look a little tired.] I'm so tired. It's actually insane.", episode: 6, context: "before tribal council" },
          ...
          "At the Episode 6 tribal, Sean tried to rally the guys to vote out Olivia, but he discovered that Ben W. had been leaking the plan to the other side.",
          "In Episode 7, at the split tribal council, Sean found himself grouped with Meredith, Ben W., Alyssa, and Ben C. He knew he was a target but had options.",
          { type: "quote", pid: "s2_sean", quote: "The biggest bullseye ever is right on my back. We have Alyssa and Ben as our two swing votes and they will determine if I go home tonight or if Meredith goes home tonight. I might have something in my pocket to help out with this situation.", episode: 7, context: "before tribal council" },
          "Meredith played her idol and voted out Alyssa 1-0, keeping Sean safe. In Episode 8, Sean's alliance tried to flush Meredith's suspected second idol while targeting Ben W.",
          { type: "quote", pid: "s2_sean", quote: "This one don't feel good about. I think my alliance of five is flipping up pretty quick. Abdul has immunity. Apparently Meredith has an immunity idol that we are going to try to flush today, but getting the votes is going to be harder than I thought.", episode: 8, context: "before tribal council" },
          "Sean built an alliance with Ashton and tried to control the post-merge votes. He won individual immunity in the Episode 9 Simon Tournament, sharing his reward with Kelsey and Ashton. Sean pushed the narrative that Meredith had found another idol, but no one wanted to listen.",
          { type: "quote", pid: "s2_sean", quote: "Meredith just found an idol. Pretty positive of it. So might end up being Abdul, but all the votes should be going on Meredith. Nobody wants to listen that she has an idol. So we might throw a vote or two [on Abdul]. See what happens.", episode: 9, context: "before tribal council" },
          "Kelsey saw through Sean's attempts to manipulate the vote and organized a 5-1-1 blindside of Ashton.",
          ...
          { type: "quote", pid: "s2_sean", quote: "I tried to get Abdul out last time. He's probably the biggest threat left in the game. They didn't want to, they went with Abdul. So Abdul plays a good idol play and now here I am. So now he has a winning game and we'll see what happens going forward with him and Meredith.", episode: 10, context: "final words" },
      ...
      { pid: "s2_ashton",    name: "Ashton",    fullName: "Ashton Sims",       instagram: "https://www.instagram.com/ashtonsims8/", photoUrl: "https://i.imgur.com/bZnfHyw.png", photoStyle: { objectPosition: "50% -15%", transformOrigin: "50% 25%", transform: "scale(1.35)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 10%" }, tid: "s2_yellow", placement: 7, juryMember: true, votesAgainst: 6, switchedTid: "s2_beige", merged: true,
        bio: [
          ...
          { type: "quote", pid: "s2_ashton", quote: "[I have] little mixed feelings. I think if I had to guess, [the person going home] would be Sam. It puts me in a tough situation because if I don't [vote him], then I'll probably be the next one out.", episode: 1, context: "before tribal council" },
          "After the swap, Ashton landed on Beige. He survived the chaotic Episode 5 tribal where Sean played his idol. Names were flying in every direction before the vote.",
          { type: "quote", pid: "s2_ashton", quote: "[How are you feeling?] Nervous. There's been like four different conversations and the name changes every time. [Who do you think you might write down?] I'm honestly not sure. [Who are the names?] Literally everyone.", episode: 5, context: "before tribal council" },
          "In the initial vote, Ashton cast the sole vote for Jacob, which became one of only two votes that counted after Sean's idol nullified the rest. On the revote, Ashton joined the unanimous vote to send Jacob home.",
          "At the merge, Ashton voted with the guys' alliance to eliminate Olivia 6-4 in Episode 6. He saw the game as a clear boys-vs-girls battle.",
          { type: "quote", pid: "s2_ashton", quote: "[I'm feeling] good. Everybody's going around talking to everybody. Nobody's really sure. [Who do you think you might vote for?] Probably Olivia. [Who are you voting with?] I think as the guys, we kind of decided that there are more girls and if we let them stay in the game, it's kind of over for us.", episode: 6, context: "before tribal council" },
          "In Episode 7, he was in Abdul's group at the split tribal council, where they voted Caroline out 4-1. Ashton heard his name floating around but stuck with the majority.",
          { type: "quote", pid: "s2_ashton", quote: "[I'm] a little nervous. I've heard my name got passed around and Caroline's name. So, we'll see. [Are you going for Caroline?] Most likely.", episode: 7, context: "before tribal council" },
          "Ashton was a loyal vote throughout — always following the majority and avoiding making waves.",
    ...
    votingHistory: [
      ...
      // ── TC 11: Ashton eliminated (5-1-1) — Merged, Ep9 ──────
      {
        ...
        confessionals: [
          ...
          { pid: "s2_abdul",    timestamp: 1669, quote: "Everyone doesn't want to sit next to me at the final three and there's some scheming going on to get me out, but I think I might have just turned it on Sean. I think Ashton might be going home just because he's going to align with Sean and just kind of follow his tail. So let's hope it works out. We got to dethrone Sean." },
  ...
  "hidden-immunity-idols": {
    ...
    seasons: {
      ...
      s2: [
        ...
        "Meredith's second idol came through a combination of luck and determination. Alyssa had originally found the clue to this idol — a 2am mailbox idol — but was voted out at Episode 7 before she could retrieve it. The clue was put back into the game, and Meredith found it. The idol was placed in the mailbox between 2:00 and 5:00 AM. Meredith snuck out at 2:30 AM to retrieve it — a bold move that could have blown up her game if anyone noticed. She played it on herself at the Episode 8 tribal council, nullifying Kelsey's vote. Ben W. was eliminated instead, having already failed his own Shot in the Dark attempt.",
