...
export const SEASONS = [
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    summary: [
      ...
      "The merge brought all remaining players together at the Episode 6 tribal council. The game immediately split along gender lines, with the guys trying to pull swing votes and the girls scrambling for numbers. Kelsey, sensing danger, played her Safety Without Power — leaving tribal before the vote and forfeiting her own ballot. The vote fell 6-4, with Olivia eliminated. Ben W. had been playing both sides, telling the girls about the guys' plan, but ultimately the numbers weren't there. Meanwhile, Abdul turned Sean's betrayal at the immunity challenge — where Sean dropped him as a partner at the last second — into an opportunity, finding both a hidden immunity idol and the Final 7 Advantage while alone at camp.",
    ...
    twists: [
      ...
      "Hidden Immunity Idols — Players could find idol clues and idols hidden at camp. Five idols were found across the season: Sean (Episode 1, played Episode 5), Caroline (Episode 2, never played), Meredith (Episode 2, played Episode 7), Abdul (Episode 6, played Episode 10), and Meredith's second idol (Episode 8, played Episode 8 — retrieved from the mailbox at 2:30am). Savannah also found an idol around Episode 9 and gave it to Abdul at the Episode 11 tribal council.",
    ...
    advantages: [
      ...
      { type: "Hidden Immunity Idol", holder: "s2_abdul", foundEpisode: 6, playedEpisode: 10, status: "played", notes: "Found at camp during Episode 6 while the rest of the tribe competed in the immunity challenge. Abdul was the odd man out after Sean dropped him last second to pair with Ashton. Played on himself at Episode 10 tribal council, nullifying 2 votes (from Meredith and Sean). Abdul didn't need to play it as the majority was already voting Sean — a wasted idol play." },
      { type: "Final 7 Advantage", holder: "s2_abdul", foundEpisode: 6, playedEpisode: 9, status: "played", notes: "Found at camp during Episode 6 while the rest of the tribe competed in the immunity challenge. Used at Episode 9 Simon Tournament immunity challenge for a bye into the semifinals." },
    ...
    cast: [
      ...
      { pid: "s2_abdul",     name: "Abdul",     fullName: "Abdul Alwan",       personId: "abdul_alwan", photoUrl: "https://i.imgur.com/O18he6C.png", photoStyle: { objectPosition: "50% -91%", transformOrigin: "66% 50%", transform: "scale(1.65)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_red",    placement: 1, juryMember: false, votesAgainst: 1, switchedTid: "s2_purple", merged: true,
        bio: [
          ...
          "At the Episode 6 merge, Abdul's game reached another level. Sean dropped him as a partner during the immunity challenge, and Abdul was sent back to camp alone. He turned the betrayal into an opportunity, searching camp and finding both a hidden immunity idol and the Final 7 Advantage.",
      ...
      { pid: "s2_savannah",  name: "Savannah",  fullName: "Savannah Brinley",  personId: "savannah_brinley", photoUrl: "https://i.imgur.com/s9JnOdy.png", photoStyle: { objectPosition: "50% -22%", transformOrigin: "22% 50%", transform: "scale(1.50)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 0%" }, tid: "s2_yellow", placement: 3, juryMember: false, votesAgainst: 0, switchedTid: "s2_beige", merged: true,
        bio: [
          "Savannah was a returning player from Season 1 who improved dramatically in Season 2, finishing as the second runner-up. Like Kelsey, Savannah never received a single vote against her all season — one of only two players to achieve that distinction.",
      ...
      { pid: "s2_ashton",    name: "Ashton",    fullName: "Ashton Sims",       instagram: "https://www.instagram.com/ashtonsims8/", photoUrl: "https://i.imgur.com/bZnfHyw.png", photoStyle: { objectPosition: "50% -15%", transformOrigin: "50% 25%", transform: "scale(1.35)" }, portraitStyle: { objectFit: "cover", width: "100%", height: "230px", objectPosition: "50% 10%" }, tid: "s2_yellow", placement: 7, juryMember: true, votesAgainst: 6, switchedTid: "s2_beige", merged: true,
        bio: [
          "Ashton started on the Yellow tribe, where he was part of the initial 3-2 vote that blindsided Sam R. in Episode 1. Ashton voted for Kelsey in that tribal — going against the majority — but he quickly adapted and aligned with Sean and Savannah going forward.",
